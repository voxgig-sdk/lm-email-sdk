...
class EmailDomainListEntity
  ...
  def make
    opts = @_entopts.dup
    EmailDomainListEntity.new(@_client, opts)
  end
  ...
  # @return [EmailDomainList, Hash] the current EmailDomainList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EmailDomainList fields)
  def match_get
  ...
  #
  # @param reqmatch [EmailDomainListListMatch, Hash, nil] match filter (any subset of
  #   EmailDomainList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EmailDomainList>, Array] the matching EmailDomainList items; raises LmEmailError on failure
