...
class EmailDomainDetailEntity
  ...
  def make
    opts = @_entopts.dup
    EmailDomainDetailEntity.new(@_client, opts)
  end
  ...
  # @return [EmailDomainDetail, Hash] the current EmailDomainDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EmailDomainDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [EmailDomainDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EmailDomainDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EmailDomainDetail, Hash] the loaded EmailDomainDetail; raises LmEmailError on failure
