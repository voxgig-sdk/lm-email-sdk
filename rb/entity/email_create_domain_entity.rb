...
class EmailCreateDomainEntity
  ...
  def make
    opts = @_entopts.dup
    EmailCreateDomainEntity.new(@_client, opts)
  end
  ...
  # @return [EmailCreateDomain, Hash] the current EmailCreateDomain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EmailCreateDomain fields)
  def match_get
  ...
  #
  # @param reqdata [EmailCreateDomainCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EmailCreateDomain, Hash] the created EmailCreateDomain; raises LmEmailError on failure
