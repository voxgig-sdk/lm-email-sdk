...
class ManageDomainEntity
  ...
  def make
    opts = @_entopts.dup
    ManageDomainEntity.new(@_client, opts)
  end
  ...
  # @return [ManageDomain, Hash] the current ManageDomain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ManageDomain fields)
  def match_get
  ...
  #
  # @param reqmatch [ManageDomainRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ManageDomain, Hash] the removed ManageDomain; raises LmEmailError on failure
