...
class SendMessageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LMEMAIL_TEST_SEND_MESSAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def send_message_basic_setup(extra)
  ...
  entid_env_raw = ENV["LMEMAIL_TEST_SEND_MESSAGE_ENTID"]
