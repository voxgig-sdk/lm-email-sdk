...
local ManageDomainEntity = {}
ManageDomainEntity.__index = ManageDomainEntity


function ManageDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ManageDomainEntity)
  self._name = "manage_domain"
  self._client = client
...
function ManageDomainEntity:get_name()
  return self._name
end


function ManageDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ManageDomainEntity.new(self._client, opts)
end
...
function ManageDomainEntity:mark_deleted()
  self._deleted = true
end


function ManageDomainEntity:deleted()
  return true == self._deleted
end


function ManageDomainEntity:data_set(args)
  if args ~= nil then
...
function ManageDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ManageDomainEntity:match_set(args)
  if args ~= nil then
...
function ManageDomainEntity:match_get()
...
function ManageDomainEntity:stream(action, args, callopts)
...
---@param reqmatch ManageDomainRemoveMatch
---@param ctrl? table
---@return ManageDomain
---@return string? err
function ManageDomainEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function ManageDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
