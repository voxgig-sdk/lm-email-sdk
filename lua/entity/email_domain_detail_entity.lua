...
local EmailDomainDetailEntity = {}
EmailDomainDetailEntity.__index = EmailDomainDetailEntity


function EmailDomainDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailDomainDetailEntity)
  self._name = "email_domain_detail"
  self._client = client
...
function EmailDomainDetailEntity:get_name()
  return self._name
end


function EmailDomainDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailDomainDetailEntity.new(self._client, opts)
end
...
function EmailDomainDetailEntity:mark_deleted()
  self._deleted = true
end


function EmailDomainDetailEntity:deleted()
  return true == self._deleted
end


function EmailDomainDetailEntity:data_set(args)
  if args ~= nil then
...
function EmailDomainDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailDomainDetailEntity:match_set(args)
  if args ~= nil then
...
function EmailDomainDetailEntity:match_get()
...
function EmailDomainDetailEntity:stream(action, args, callopts)
...
---@param reqmatch EmailDomainDetailLoadMatch
---@param ctrl? table
---@return EmailDomainDetail
---@return string? err
function EmailDomainDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmailDomainDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailDomainDetailEntity
