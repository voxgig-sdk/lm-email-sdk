...
local EmailCreateDomainEntity = {}
EmailCreateDomainEntity.__index = EmailCreateDomainEntity


function EmailCreateDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailCreateDomainEntity)
  self._name = "email_create_domain"
  self._client = client
...
function EmailCreateDomainEntity:get_name()
  return self._name
end


function EmailCreateDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailCreateDomainEntity.new(self._client, opts)
end
...
function EmailCreateDomainEntity:mark_deleted()
  self._deleted = true
end


function EmailCreateDomainEntity:deleted()
  return true == self._deleted
end


function EmailCreateDomainEntity:data_set(args)
  if args ~= nil then
...
function EmailCreateDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailCreateDomainEntity:match_set(args)
  if args ~= nil then
...
function EmailCreateDomainEntity:match_get()
...
function EmailCreateDomainEntity:stream(action, args, callopts)
...
---@param reqdata EmailCreateDomainCreateData
---@param ctrl? table
---@return EmailCreateDomain
---@return string? err
function EmailCreateDomainEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EmailCreateDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailCreateDomainEntity
