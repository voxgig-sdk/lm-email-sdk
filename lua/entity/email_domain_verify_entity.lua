...
local EmailDomainVerifyEntity = {}
EmailDomainVerifyEntity.__index = EmailDomainVerifyEntity


function EmailDomainVerifyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailDomainVerifyEntity)
  self._name = "email_domain_verify"
  self._client = client
...
function EmailDomainVerifyEntity:get_name()
  return self._name
end


function EmailDomainVerifyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailDomainVerifyEntity.new(self._client, opts)
end
...
function EmailDomainVerifyEntity:mark_deleted()
  self._deleted = true
end


function EmailDomainVerifyEntity:deleted()
  return true == self._deleted
end


function EmailDomainVerifyEntity:data_set(args)
  if args ~= nil then
...
function EmailDomainVerifyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailDomainVerifyEntity:match_set(args)
  if args ~= nil then
...
function EmailDomainVerifyEntity:match_get()
...
function EmailDomainVerifyEntity:stream(action, args, callopts)
...
---@param reqmatch EmailDomainVerifyLoadMatch
---@param ctrl? table
---@return EmailDomainVerify
---@return string? err
function EmailDomainVerifyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmailDomainVerifyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailDomainVerifyEntity
