...
local EmailDomainListEntity = {}
EmailDomainListEntity.__index = EmailDomainListEntity


function EmailDomainListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailDomainListEntity)
  self._name = "email_domain_list"
  self._client = client
...
function EmailDomainListEntity:get_name()
  return self._name
end


function EmailDomainListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailDomainListEntity.new(self._client, opts)
end
...
function EmailDomainListEntity:mark_deleted()
  self._deleted = true
end


function EmailDomainListEntity:deleted()
  return true == self._deleted
end


function EmailDomainListEntity:data_set(args)
  if args ~= nil then
...
function EmailDomainListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailDomainListEntity:match_set(args)
  if args ~= nil then
...
function EmailDomainListEntity:match_get()
...
function EmailDomainListEntity:stream(action, args, callopts)
...
---@param reqmatch EmailDomainListListMatch
---@param ctrl? table
---@return EmailDomainList[]
---@return string? err
function EmailDomainListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmailDomainListEntity:_run_op(ctx, post_done)
  local utility = self._utility
