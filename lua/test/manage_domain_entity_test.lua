...
describe("ManageDomainEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LM_EMAIL_TEST_MANAGE_DOMAIN_ENTID JSON to run live")
      return
    end
...
function manage_domain_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LM_EMAIL_TEST_MANAGE_DOMAIN_ENTID")
