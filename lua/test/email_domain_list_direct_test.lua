...
describe("EmailDomainListDirect", function()
  it("should direct-list-email_domain_list", function()
    local setup = email_domain_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-email_domain_list", setup.live and "live" or "unit")
...
function email_domain_list_direct_setup(mockres)
