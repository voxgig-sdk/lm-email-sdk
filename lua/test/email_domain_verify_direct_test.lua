...
describe("EmailDomainVerifyDirect", function()
  it("should direct-load-email_domain_verify", function()
    local setup = email_domain_verify_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-email_domain_verify", setup.live and "live" or "unit")
...
function email_domain_verify_direct_setup(mockres)
