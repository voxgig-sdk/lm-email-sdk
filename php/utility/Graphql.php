...
class LmEmailGraphql
{
    ...
    // equivalent.
    public static function body(LmEmailContext $ctx): mixed
    {
    ...
    public static function errors(LmEmailContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
