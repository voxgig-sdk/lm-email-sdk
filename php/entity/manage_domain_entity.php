...
// LmEmail SDK ManageDomain entity
...
class ManageDomainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ManageDomainEntity($this->_client, $opts);
    }

    /**
     * @param ManageDomain|array $args ManageDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return ManageDomain|array The current ManageDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ManageDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ManageDomain fields).
     */
    ...
    /**
     * Remove an ManageDomain matching the given criteria.
     *
     * @param ManageDomainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ManageDomainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ManageDomain|array The removed ManageDomain as an assoc-array at the
