...
// LmEmail SDK EmailDomainList entity
...
class EmailDomainListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmailDomainListEntity($this->_client, $opts);
    }

    /**
     * @param EmailDomainList|array $args EmailDomainList data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailDomainList|array The current EmailDomainList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailDomainList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailDomainList fields).
     */
    ...
    /**
     * List EmailDomainList items matching the given filter.
     *
     * @param EmailDomainListListMatch|array|null $reqmatch Match filter (any subset
     *   of EmailDomainList fields) as an assoc-array; EmailDomainListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailDomainList[]|array A list of EmailDomainList items as assoc-arrays at
     *   the SDK boundary; throws LmEmailError on failure (item-5 convention).
     */
