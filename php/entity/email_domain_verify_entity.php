...
// LmEmail SDK EmailDomainVerify entity
...
class EmailDomainVerifyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_domain_verify";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailDomainVerifyEntity($this->_client, $opts);
    }

    /**
     * @param EmailDomainVerify|array $args EmailDomainVerify data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailDomainVerify|array The current EmailDomainVerify data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailDomainVerify fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailDomainVerify fields).
     */
    ...
    /**
     * Load a single EmailDomainVerify.
     *
     * @param EmailDomainVerifyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmailDomainVerifyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailDomainVerify|array The loaded EmailDomainVerify as an assoc-array at the
