...
// LmEmail SDK EmailCreateDomain entity
...
class EmailCreateDomainEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_create_domain";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailCreateDomainEntity($this->_client, $opts);
    }

    /**
     * @param EmailCreateDomain|array $args EmailCreateDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailCreateDomain|array The current EmailCreateDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailCreateDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailCreateDomain fields).
     */
    ...
    /**
     * Create a new EmailCreateDomain.
     *
     * @param EmailCreateDomainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailCreateDomainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailCreateDomain|array The created EmailCreateDomain as an assoc-array at the
