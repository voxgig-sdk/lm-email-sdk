...
class LmEmailRatelimitFeature extends LmEmailBaseFeature
{
    ...
    private function _acquire(LmEmailContext $ctx): void
    {
    ...
    private function _track(LmEmailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
