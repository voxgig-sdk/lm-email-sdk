...
class LmEmailPagingFeature extends LmEmailBaseFeature
{
    ...
    private function _graphql_pre_request(LmEmailContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(LmEmailContext $ctx): bool
    {
