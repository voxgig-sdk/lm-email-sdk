...
// LmEmail SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LmEmailTestFeature extends LmEmailBaseFeature
{
    ...
    public function init(LmEmailContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LmEmailContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LmEmailContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LmEmailContext $ctx, $op, $args): array
    {
