...
class LmEmailRbacFeature extends LmEmailBaseFeature
{
    ...
    private function _required(LmEmailContext $ctx): ?string
    {
    ...
    private function _reject(LmEmailContext $ctx, string $required): void
    {
    ...
    private function _track(LmEmailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
