...
// LmEmail SDK clienttrack feature
...
class LmEmailClienttrackFeature extends LmEmailBaseFeature
{
    ...
    public function PostConstruct(LmEmailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LmEmail-SDK';
