...
class LmEmailStreamingFeature extends LmEmailBaseFeature
{
    ...
    private function _iterate(LmEmailResult $result): \Generator
    {
    ...
    private function _streamable(LmEmailContext $ctx): bool
    {
