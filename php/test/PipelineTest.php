...
{
    private static function utility(): LmEmailUtility
    {
        return new LmEmailUtility();
    }
    ...
    private static function ctx(array $over = []): LmEmailContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LmEmailContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LmEmailOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LmEmailError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LmEmailOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LmEmailMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LmEmailOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LmEmailMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LmEmailOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LmEmailMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmEmailSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LmEmailMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = LmEmailMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LmEmailSpec([]),
            'response' => null,
            'result' => new LmEmailResult([]),
        ]);
        [, $err] = LmEmailMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LmEmailSpec(['step' => 's']),
            'response' => new LmEmailResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LmEmailResult([]),
        ]);
        [, $err] = LmEmailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LmEmailSpec(['step' => 's']),
            'response' => new LmEmailResponse(self::resp(200, ['v' => 1])),
            'result' => new LmEmailResult([]),
        ]);
        [, $err] = LmEmailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LmEmailSpec(['step' => 's']),
            'response' => new LmEmailResponse(self::resp(200, ['v' => 2])),
            'result' => new LmEmailResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LmEmailMakeResponse::call($ctx);
    ...
    {
        $preset = new LmEmailResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LmEmailSpec([]),
            'response' => new LmEmailResponse([]),
            'result' => new LmEmailResult([]),
        ...
        [$got, $err] = LmEmailMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LmEmailResult([])]);
        [, $err] = LmEmailMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LmEmailSpec([]), 'result' => null]);
        [, $err] = LmEmailMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmEmailSpec(['step' => 's']),
            'result' => new LmEmailResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LmEmailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmEmailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmEmailSpec(['step' => 's']),
            'result' => new LmEmailResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LmEmailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmEmailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmEmailResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LmEmailSpec([]),
            'result' => new LmEmailResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LmEmailMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmEmailMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LmEmailError('boom', 'boom');
        $utility->fetcher = function (LmEmailContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmEmailSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LmEmailMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LmEmailContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LmEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LmEmailResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LmEmailContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmEmailSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LmEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LmEmailResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LmEmailSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LmEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LmEmailMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LmEmailMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LmEmailResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LmEmailDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LmEmailResult(['ok' => false])]);
        $this->expectException(LmEmailError::class);
        LmEmailDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LmEmailResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LmEmailMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LmEmailMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LmEmailBaseFeature();
        $b = new LmEmailBaseFeature();
        LmEmailFeatureAdd::call($ctx, $a);
        LmEmailFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LmEmailBaseFeature
    {
        $f = new LmEmailBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LmEmailFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LmEmailContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LmEmailSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LmEmailPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LmEmailResponse(['headers' => null]),
            'result' => new LmEmailResult([]),
        ]);
        LmEmailResultHeaders::call($ctx);
