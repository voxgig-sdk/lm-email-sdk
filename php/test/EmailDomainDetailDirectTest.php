...
class EmailDomainDetailDirectTest extends TestCase
{
    public function test_direct_load_email_domain_detail(): void
    {
        ...
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-email_domain_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function email_domain_detail_direct_setup($mockres)
{
