...
// LmEmail SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LmEmailOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LmEmailOmni::structfix($now, Struct::undef()))
                        !== json_encode(LmEmailOmni::structfix($val, Struct::undef()))) {
