...
class EmailCreateDomainEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LMEMAIL_TEST_EMAIL_CREATE_DOMAIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function email_create_domain_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LMEMAIL_TEST_EMAIL_CREATE_DOMAIN_ENTID");
