...
// LmEmail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LmEmailSDK::test)
...
{
    private const SDK_CLASS = 'LmEmailSDK';
    ...
    private const SDK_BASE = 'lmemail_sdk';
