...
class SendMessageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LM_EMAIL_TEST_SEND_MESSAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function send_message_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LM_EMAIL_TEST_SEND_MESSAGE_ENTID");
