...
class EmailDomainListDirectTest extends TestCase
{
    public function test_direct_list_email_domain_list(): void
    {
        $setup = email_domain_list_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-email_domain_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
