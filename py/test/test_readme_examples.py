# LmEmail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LmEmailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LmEmailSDK(...) and LmEmailSDK.test(...) become
#      LmEmailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lmemail_sdk"
_SDK_CLASS = "LmEmailSDK"
