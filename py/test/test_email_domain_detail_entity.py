...
class TestEmailDomainDetailEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        email_domain_detail_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(email_domain_detail_ref01_data_dt0_loaded))
...
def _email_domain_detail_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("LM_EMAIL_TEST_EMAIL_DOMAIN_DETAIL_ENTID"))
