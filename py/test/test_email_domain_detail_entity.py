    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LMEMAIL_TEST_EMAIL_DOMAIN_DETAIL_ENTID JSON to run live")
        client = setup["client"]
        ...
        email_domain_detail_ref01_data_dt0_loaded = email_domain_detail_ref01_ent.load(email_domain_detail_ref01_match_dt0, None)
        email_domain_detail_ref01_data_dt0_load_result = helpers.to_map(email_domain_detail_ref01_data_dt0_loaded)
        assert email_domain_detail_ref01_data_dt0_load_result is not None
        assert email_domain_detail_ref01_data_dt0_load_result["id"] == email_domain_detail_ref01_data["id"]



def _email_domain_detail_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("LMEMAIL_TEST_EMAIL_DOMAIN_DETAIL_ENTID"))
