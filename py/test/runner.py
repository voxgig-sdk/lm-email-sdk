...
class LmEmailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmEmailTestRunner.getenv("LM_EMAIL_TEST_LIVE")
        override = LmEmailTestRunner.getenv("LM_EMAIL_TEST_OVERRIDE")
        ...
        explain = LmEmailTestRunner.getenv("LM_EMAIL_TEST_EXPLAIN")
