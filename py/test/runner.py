...
class LmEmailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmEmailTestRunner.getenv("LMEMAIL_TEST_LIVE")
        override = LmEmailTestRunner.getenv("LMEMAIL_TEST_OVERRIDE")
        ...
        explain = LmEmailTestRunner.getenv("LMEMAIL_TEST_EXPLAIN")
