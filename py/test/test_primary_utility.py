...
from lmemail_sdk.core.response import LmEmailResponse
from lmemail_sdk.core.operation import LmEmailOperation
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LmEmailSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = LmEmailSDK.test(None, None)
        ...
        class TestInitFeature(LmEmailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LmEmailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LmEmailSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LmEmailSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LmEmailSDK.test(None, setup_opts)
