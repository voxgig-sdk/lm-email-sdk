...
from core.utility_type import LmEmailUtility
...
class LmEmailSDK:
    ...
    def get_utility(self):
        return LmEmailUtility.copy(self._utility)
    ...
    def EmailCreateDomain(self, data=None) -> "EmailCreateDomainEntity":
        ...
        from entity.email_create_domain_entity import EmailCreateDomainEntity
    ...
    def EmailDomainDetail(self, data=None) -> "EmailDomainDetailEntity":
        ...
        from entity.email_domain_detail_entity import EmailDomainDetailEntity
    ...
    def EmailDomainList(self, data=None) -> "EmailDomainListEntity":
        ...
        from entity.email_domain_list_entity import EmailDomainListEntity
    ...
    def EmailDomainVerify(self, data=None) -> "EmailDomainVerifyEntity":
        ...
        from entity.email_domain_verify_entity import EmailDomainVerifyEntity
        return EmailDomainVerifyEntity(self, data)


    def ManageDomain(self, data=None) -> "ManageDomainEntity":
        """Entity factory: client.ManageDomain().list() / client.ManageDomain().load({"id": ...})."""
        from entity.manage_domain_entity import ManageDomainEntity
        return ManageDomainEntity(self, data)
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "LmEmailSDK":
        if sdkopts is None:
            sdkopts = {}
