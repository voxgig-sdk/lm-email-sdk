...
from lmemail_sdk.core.helpers import get_ctx_prop, to_map
...
class LmEmailContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, LmEmailResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LmEmailError(code, msg, self)
