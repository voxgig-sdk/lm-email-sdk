...
class EmailDomainListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailDomainListEntity(self._client, opts)
    ...
    def data_get(self) -> EmailDomainList:
    ...
    def match_get(self) -> EmailDomainList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmailDomainList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmailDomainList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
