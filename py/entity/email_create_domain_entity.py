...
class EmailCreateDomainEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailCreateDomainEntity(self._client, opts)
    ...
    def data_get(self) -> EmailCreateDomain:
    ...
    def match_get(self) -> EmailCreateDomain:
    ...
    def create(self, reqdata: EmailCreateDomainCreateData, ctrl=None) -> EmailCreateDomain:
        utility = self._utility
