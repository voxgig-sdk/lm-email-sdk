...
type ManageDomainEntity struct {
	name    string
...
func NewManageDomainEntity(client *core.LmEmailSDK, entopts map[string]any) *ManageDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ManageDomainEntity) GetName() string { return e.name }
...
func (e *ManageDomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ManageDomainEntity) Deleted() bool {
	return e.deleted
}


func (e *ManageDomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewManageDomainEntity(e.client, opts)
}

func (e *ManageDomainEntity) Data(args ...any) any {
...
func (e *ManageDomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ManageDomain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ManageDomainEntity) DataTyped(data ...ManageDomain) ManageDomain {
	if len(data) > 0 {
		return typedFrom[ManageDomain](e.Data(asMap(data[0])))
	}
	return typedFrom[ManageDomain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ManageDomain (all fields
// optional at the wire level).
func (e *ManageDomainEntity) MatchTyped(match ...ManageDomain) ManageDomain {
	if len(match) > 0 {
		return typedFrom[ManageDomain](e.Match(asMap(match[0])))
	}
	return typedFrom[ManageDomain](e.Match())
}
...
func (e *ManageDomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ManageDomainEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ManageDomainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ManageDomainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ManageDomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ManageDomainEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ManageDomainRemoveMatch and returns an ManageDomain. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ManageDomainEntity) RemoveTyped(reqmatch ManageDomainRemoveMatch, ctrl map[string]any) (ManageDomain, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ManageDomain{}, err
	}
	return typedFrom[ManageDomain](res), nil
}



func (e *ManageDomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
