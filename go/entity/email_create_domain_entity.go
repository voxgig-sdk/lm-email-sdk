...
type EmailCreateDomainEntity struct {
	name    string
	client  *core.LmEmailSDK
...
func NewEmailCreateDomainEntity(client *core.LmEmailSDK, entopts map[string]any) *EmailCreateDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailCreateDomainEntity) GetName() string { return e.name }
...
func (e *EmailCreateDomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailCreateDomainEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailCreateDomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailCreateDomainEntity(e.client, opts)
}

func (e *EmailCreateDomainEntity) Data(args ...any) any {
...
func (e *EmailCreateDomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailCreateDomain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailCreateDomainEntity) DataTyped(data ...EmailCreateDomain) EmailCreateDomain {
	if len(data) > 0 {
		return typedFrom[EmailCreateDomain](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailCreateDomain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailCreateDomain (all fields
// optional at the wire level).
func (e *EmailCreateDomainEntity) MatchTyped(match ...EmailCreateDomain) EmailCreateDomain {
	if len(match) > 0 {
		return typedFrom[EmailCreateDomain](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailCreateDomain](e.Match())
}
...
func (e *EmailCreateDomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailCreateDomainEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmailCreateDomainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EmailCreateDomainEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmailCreateDomainCreateData and returns an EmailCreateDomain. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EmailCreateDomainEntity) CreateTyped(reqdata EmailCreateDomainCreateData, ctrl map[string]any) (EmailCreateDomain, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EmailCreateDomain{}, err
	}
	return typedFrom[EmailCreateDomain](res), nil
}



func (e *EmailCreateDomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmailCreateDomainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailCreateDomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
