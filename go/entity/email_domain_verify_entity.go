...
type EmailDomainVerifyEntity struct {
	name    string
...
func NewEmailDomainVerifyEntity(client *core.LmEmailSDK, entopts map[string]any) *EmailDomainVerifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailDomainVerifyEntity) GetName() string { return e.name }
...
func (e *EmailDomainVerifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailDomainVerifyEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailDomainVerifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailDomainVerifyEntity(e.client, opts)
}

func (e *EmailDomainVerifyEntity) Data(args ...any) any {
...
func (e *EmailDomainVerifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailDomainVerify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailDomainVerifyEntity) DataTyped(data ...EmailDomainVerify) EmailDomainVerify {
	if len(data) > 0 {
		return typedFrom[EmailDomainVerify](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailDomainVerify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailDomainVerify (all fields
// optional at the wire level).
func (e *EmailDomainVerifyEntity) MatchTyped(match ...EmailDomainVerify) EmailDomainVerify {
	if len(match) > 0 {
		return typedFrom[EmailDomainVerify](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailDomainVerify](e.Match())
}
...
func (e *EmailDomainVerifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailDomainVerifyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmailDomainVerifyLoadMatch and returns an EmailDomainVerify. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EmailDomainVerifyEntity) LoadTyped(reqmatch EmailDomainVerifyLoadMatch, ctrl map[string]any) (EmailDomainVerify, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EmailDomainVerify{}, err
	}
	return typedFrom[EmailDomainVerify](res), nil
}



func (e *EmailDomainVerifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EmailDomainVerifyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EmailDomainVerifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmailDomainVerifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailDomainVerifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
