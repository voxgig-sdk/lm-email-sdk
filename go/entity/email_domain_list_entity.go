...
type EmailDomainListEntity struct {
	name    string
...
func NewEmailDomainListEntity(client *core.LmEmailSDK, entopts map[string]any) *EmailDomainListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailDomainListEntity) GetName() string { return e.name }
...
func (e *EmailDomainListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailDomainListEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailDomainListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailDomainListEntity(e.client, opts)
}

func (e *EmailDomainListEntity) Data(args ...any) any {
...
func (e *EmailDomainListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailDomainList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailDomainListEntity) DataTyped(data ...EmailDomainList) EmailDomainList {
	if len(data) > 0 {
		return typedFrom[EmailDomainList](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailDomainList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailDomainList (all fields
// optional at the wire level).
func (e *EmailDomainListEntity) MatchTyped(match ...EmailDomainList) EmailDomainList {
	if len(match) > 0 {
		return typedFrom[EmailDomainList](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailDomainList](e.Match())
}
...
func (e *EmailDomainListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailDomainListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EmailDomainListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmailDomainListListMatch and returns []EmailDomainList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EmailDomainListEntity) ListTyped(reqmatch EmailDomainListListMatch, ctrl map[string]any) ([]EmailDomainList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EmailDomainList](res), nil
}



func (e *EmailDomainListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EmailDomainListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmailDomainListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailDomainListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
