...
type EmailDomainDetailEntity struct {
	name    string
...
func NewEmailDomainDetailEntity(client *core.LmEmailSDK, entopts map[string]any) *EmailDomainDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailDomainDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailDomainDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailDomainDetailEntity(e.client, opts)
}

func (e *EmailDomainDetailEntity) Data(args ...any) any {
...
func (e *EmailDomainDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailDomainDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailDomainDetailEntity) DataTyped(data ...EmailDomainDetail) EmailDomainDetail {
	if len(data) > 0 {
		return typedFrom[EmailDomainDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailDomainDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailDomainDetail (all fields
// optional at the wire level).
func (e *EmailDomainDetailEntity) MatchTyped(match ...EmailDomainDetail) EmailDomainDetail {
	if len(match) > 0 {
		return typedFrom[EmailDomainDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailDomainDetail](e.Match())
}
...
func (e *EmailDomainDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailDomainDetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmailDomainDetailLoadMatch and returns an EmailDomainDetail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EmailDomainDetailEntity) LoadTyped(reqmatch EmailDomainDetailLoadMatch, ctrl map[string]any) (EmailDomainDetail, error) {
...
func (e *EmailDomainDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
