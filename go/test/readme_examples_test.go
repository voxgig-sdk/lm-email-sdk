...
const testSeed = `map[string]any{"entity": map[string]any{"email_create_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_domain_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_domain_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_domain_verify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "manage_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
