...
func TestManageDomainEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set LM_EMAIL_TEST_MANAGE_DOMAIN_ENTID JSON to run live")
			return
		}
...
func manage_domainBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LM_EMAIL_TEST_MANAGE_DOMAIN_ENTID")
