...
class LmEmailSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('LmEmailSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EmailDomainVerify(entopts?: Record<string, any>) {
    const self = this
    return new EmailDomainVerifyEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ManageDomain(entopts?: Record<string, any>) {
    const self = this
    return new ManageDomainEntity(self, entopts)
  }
