...
class LmEmailSDK {
  ...
  EmailCreateDomain(data?: any) {
    const self = this
    return new EmailCreateDomainEntity(self,data)
  }


  // Entity access: `client.EmailDomainDetail().list()` / `client.EmailDomainDetail().load({ id })`.
  EmailDomainDetail(data?: any) {
    const self = this
    return new EmailDomainDetailEntity(self,data)
  }


  // Entity access: `client.EmailDomainList().list()` / `client.EmailDomainList().load({ id })`.
  EmailDomainList(data?: any) {
    const self = this
    return new EmailDomainListEntity(self,data)
  }


  // Entity access: `client.EmailDomainVerify().list()` / `client.EmailDomainVerify().load({ id })`.
  EmailDomainVerify(data?: any) {
    const self = this
    return new EmailDomainVerifyEntity(self,data)
  }


  // Entity access: `client.ManageDomain().list()` / `client.ManageDomain().load({ id })`.
  ManageDomain(data?: any) {
    const self = this
    return new ManageDomainEntity(self,data)
  }
