...
describe('EmailDomainListDirect', async () => {
  ...
  test('direct-list-email_domain_list', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-email_domain_list', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LM_EMAIL_TEST_EMAIL_DOMAIN_LIST_ENTID']
