...
function envOverride(m) {
    if ('TRUE' === process.env.LMEMAIL_TEST_LIVE ||
        'TRUE' === process.env.LMEMAIL_TEST_OVERRIDE) {
    ...
    m.LMEMAIL_TEST_EXPLAIN = process.env.LMEMAIL_TEST_EXPLAIN || m.LMEMAIL_TEST_EXPLAIN;
    return m;
}
