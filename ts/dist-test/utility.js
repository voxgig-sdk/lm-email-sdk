...
function envOverride(m) {
    if ('TRUE' === process.env.LM_EMAIL_TEST_LIVE ||
        'TRUE' === process.env.LM_EMAIL_TEST_OVERRIDE) {
    ...
    m.LM_EMAIL_TEST_EXPLAIN = process.env.LM_EMAIL_TEST_EXPLAIN || m.LM_EMAIL_TEST_EXPLAIN;
    return m;
}
