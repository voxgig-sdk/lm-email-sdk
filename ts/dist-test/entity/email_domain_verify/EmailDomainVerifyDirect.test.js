...
(0, node_test_1.describe)('EmailDomainVerifyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-email_domain_verify', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-email_domain_verify', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["domain_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LmEmailSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.LM_EMAIL_APIKEY,
        }));
        let idmap = env['LM_EMAIL_TEST_EMAIL_DOMAIN_VERIFY_ENTID'];
...
//# sourceMappingURL=EmailDomainVerifyDirect.test.js.map