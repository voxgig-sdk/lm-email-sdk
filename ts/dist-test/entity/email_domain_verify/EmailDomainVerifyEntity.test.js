...
(0, node_test_1.describe)('EmailDomainVerifyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'email_domain_verify.' + op, live))
                return;
        }
        ...
        let email_domain_verify_ref01_data = Object.values(setup.data.existing.email_domain_verify)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/email_domain_verify/EmailDomainVerifyTestData.json');
    ...
    let idmap = transform(['email_domain_verify01', 'email_domain_verify02', 'email_domain_verify03', 'domain01', 'domain02', 'domain03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EmailDomainVerifyEntity.test.js.map