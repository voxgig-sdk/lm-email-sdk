...
(0, node_test_1.describe)('EmailDomainDetailEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'email_domain_detail.' + op, live))
                return;
        }
        ...
        let email_domain_detail_ref01_data = Object.values(setup.data.existing.email_domain_detail)[0];
        // LOAD
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['LM_EMAIL_TEST_EMAIL_DOMAIN_DETAIL_ENTID'];
