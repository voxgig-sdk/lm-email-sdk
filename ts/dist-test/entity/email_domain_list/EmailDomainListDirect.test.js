...
(0, node_test_1.describe)('EmailDomainListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-email_domain_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-email_domain_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LM_EMAIL_TEST_EMAIL_DOMAIN_LIST_ENTID'];
...
//# sourceMappingURL=EmailDomainListDirect.test.js.map