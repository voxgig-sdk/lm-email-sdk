...
class EmailDomainListEntity extends LmEmailEntityBase_1.LmEmailEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'email_domain_list';
        this.name_ = 'email_domain_list';
        this.Name = 'EmailDomainList';
    }
    make() {
        return new EmailDomainListEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<EmailDomainList[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.EmailDomainListEntity = EmailDomainListEntity;
//# sourceMappingURL=EmailDomainListEntity.js.map