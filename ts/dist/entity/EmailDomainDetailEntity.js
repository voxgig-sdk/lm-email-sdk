    ...
    async load(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<EmailDomainDetail> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.EmailDomainDetailEntity = EmailDomainDetailEntity;
//# sourceMappingURL=EmailDomainDetailEntity.js.map