...
func registerSDKWords(r *eng.Registry, client *sdk.LmEmailSDK) {
...
func runOp(client *sdk.LmEmailSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
