...
|---|---|---|
| `ts/` | @voxgig-sdk/lm-email | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lm-email \
      --repository voxgig-sdk/lm-email-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lm-email` shows it, and
`npm trust revoke @voxgig-sdk/lm-email --id=<id>` removes it.
