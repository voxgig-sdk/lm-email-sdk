...
class LmEmailNetsimFeature extends LmEmailBaseFeature
{
    ...
    private function _simulate(LmEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LmEmailContext $ctx, array $applied): void
    {
        $client = $this->client;
