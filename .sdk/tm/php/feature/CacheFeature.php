...
class LmEmailCacheFeature extends LmEmailBaseFeature
{
    ...
    private function _through(LmEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
