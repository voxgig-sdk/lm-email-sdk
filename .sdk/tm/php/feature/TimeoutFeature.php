...
class LmEmailTimeoutFeature extends LmEmailBaseFeature
{
    ...
    private function _with_timeout(LmEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LmEmailContext $_ctx, float $ms): void
    {
        $client = $this->client;
