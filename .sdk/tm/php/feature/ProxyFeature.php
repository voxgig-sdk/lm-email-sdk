...
class LmEmailProxyFeature extends LmEmailBaseFeature
{
    ...
    public function init(LmEmailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LmEmailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
