...
// LmEmail SDK utility: fetcher

class LmEmailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LmEmailSDK/1.0)';
    ...
    public static function call(LmEmailContext $ctx, string $fullurl, array $fetchdef): array
    {
