...
class LmEmailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LmEmailTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LmEmailTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LmEmailTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
