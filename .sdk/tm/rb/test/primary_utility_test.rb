...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = LmEmailOmni.make_runner(TEST_JSON_FILE, LmEmailSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : LmEmailOmni.errify(err)
    end
